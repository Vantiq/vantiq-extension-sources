...
public class TestConnectorMain {

    static final Logger log = LoggerFactory.getLogger(TestConnectorMain.class);
    static List<TestConnectorCore> sources;
     ...
     */
    private static void startSources(List<TestConnectorCore> sources) {
        for (TestConnectorCore source : sources) {
     ...
     */
    static List<TestConnectorCore> createSources(Properties config) {
        ...
        for (String sourceName : sourceNames) {
            ...
            TestConnectorCore source;
            source = new TestConnectorCore(sourceName, authToken, targetVantiqServer);
            sources.add(source);
        }
