...
//                {-83.74800177407815f, 42.78187357400434f},
        ...
        assertFalse("Source Points Collinear", CoordinateConverterFloat.checkCollinearity(alleyCam1SrcPts));
        assertFalse("Destination Points Collinear", CoordinateConverterFloat.checkCollinearity(alleyCam1DstPts, 0.00001f));
    ...
    protected void performConverterTest(Float[][] srcPts, Float[][] dstPts, Float[][] tstSrc, Float[][] tstRes) {
        ...
        CoordinateConverterFloat converter = new CoordinateConverterFloat(srcPts, dstPts);
