...
* **headerDuplicationBeanName** [optional] the name of the bean containing the header duplication specification. See 
  _Header Duplication_ section for more details.
