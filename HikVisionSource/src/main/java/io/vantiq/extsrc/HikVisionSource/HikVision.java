            ...
            default:
                {
                    ...
                    log.info("upload alarm,alarm message type:" + lCommand);
                    break;
                }
        }
    }
...
//        o.ImageName = "D:/TMP/Thermo/Device_ID_Pic_[211.140.29.11]_lUerID_[0]_0100014302.jpg";
    ...
    boolean initCamera()
    {
        ...
        else
        {
            ...
            Pointer pUser = null;
            hCNetSDK.NET_DVR_SetDVRMessageCallBack_V31(m_falarmData_V31, pUser);
        }
    ...
    private boolean SetAlarm(CameraEntry camera)
    {
       // NativeLong lAlarmHandle = hCNetSDK.NET_DVR_SetupAlarmChan_V30(lUserID);
        ...
        {
            iLastErr = hCNetSDK.NET_DVR_GetLastError();
            log.error("Failed to arm camera {}, Error code: {0}", camera.CameraId,iLastErr);
            return false;
        }
        else
